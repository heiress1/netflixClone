                ...
                <div className="flex items-center justify-center w-full px-4 mt-4">
                    ...
                    <form onSubmit={handleFormSubmit} className="flex flex-col lg:flex-row gap-4 w-full max-w-xl px-11 sm:px-6 md:px-11 lg:px-0">
                        <input
                            ...
                            className="p-2 lg:p-4 rounded-md bg-black/80 border border-gray-700 flex-grow text-lg lg:text-xl"
                            value={email}
                            onChange={(e) => setEmail(e.target.value)}
                        />
                        <button
                            className="bg-red-600 hover:bg-red-700 text-lg lg:text-xl px-4 lg:px-6 py-2 lg:py-3 rounded-md flex justify-center items-center w-full lg:w-auto transition duration-300"
            ...
            <div className="py-10 bg-black text-white ">
              ...
              "
                        ...
                        <div className="flex-1 md:text-left text-center">
                            <h2 className="text-4xl md:text-5xl font-extrabold mb-4 mt-0 text-balance">
				...
				>
					...
					{/* right */}
					<div className='flex-1 text-center md:text-left'>
						<h2 className='text-4xl md:text-5xl mt-8 font-extrabold mb-4'>Create profiles for kids</h2>
						<p className='text-lg md:text-xl'> 
